...
# python
sys.path.append('/d2/python_venv/3.6/djlingua/lib/python3.6/')
sys.path.append('/d2/python_venv/3.6/djlingua/lib/python3.6/site-packages/')
# django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'djlingua.settings.staging')
