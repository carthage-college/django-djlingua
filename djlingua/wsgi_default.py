...
# python
sys.path.append('/data2/python_venv/2.7/djlingua/lib/python2.7/')
sys.path.append('/data2/python_venv/2.7/djlingua/lib/python2.7/site-packages/')
sys.path.append('/data2/python_venv/2.7/djlingua/lib/django_projects/')
sys.path.append('/data2/python_venv/2.7/djlingua/lib/django-djlingua/')
# django
